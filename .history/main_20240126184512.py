...
@st.cache_resource
def get_fawkes():
    protector = Fawkes("extractor_0", "cpu", 1)
    return protector


def main():
    st.title("Deface: Cloak your images to protect your privacy")
    st.write("Fawkes is a system for disguising images to evade facial recognition.")
    st.write("This app uses Fawkes to cloak your images.")
    st.write("More info: https://sandlab.cs.uchicago.edu/fawkes/")
    st.write(
